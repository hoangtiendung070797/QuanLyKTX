...
{
    public partial class FrmSuaPhieuBaoHong : Form
    {
        public FrmSuaPhieuBaoHong()
        {
            InitializeComponent();
            LoadComBoBox();
            SetColumn_ThietBi();
        ...
        public int GetPhieuBaoHongId = 0;
        public int i = 1;
        #endregion
        ...
        {
            MessageBox.Show(GetPhieuBaoHongId.ToString());
        }
        ...
        private void btnTaoPhieu_Click(object sender, EventArgs e)
        {
            ...
            {                        
                ...
                {
                    if (listViewThietBi.Items.Count == 0)
                    {
                ...
                MessageBox.Show("Đã cập nhật phiếu", "Thông báo");
                this.Close();               
            }
            catch
            {
